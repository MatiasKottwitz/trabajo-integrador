...
public class VistaEntidades implements Vista{
    ...
    public Parent obtenerVista() {
        ...
        Separator separado3 = new Separator(Orientation.HORIZONTAL);
        ...
        contenedorDatos.add(nombreTextField, 2, 2, 3, 1);
        ...
        Boolean tipo;
        if ("Publica".equals(comboTipo.getId())){
            tipo=true;
        }else{
            tipo=false;
        }
        
        contenedorDatos.add(nuevoButton, 3, 3);
        contenedorDatos.add(guardarButton,4,3);
        
        // contenedor de botones
        /*HBox contenedorBotones = new HBox();
        contenedorBotones.setAlignment(Pos.CENTER);
        contenedorBotones.setPadding(new Insets(0, 10, 0, 10));
        contenedorBotones.setSpacing(10);
        contenedorBotones.getChildren().addAll(nuevoButton, guardarButton);*/
        
        contenedorDatos.add(separador, 1, 4,10,1); //separador de entrada  yde lista
        contenedorDatos.add(personaLabel, 1, 5);
        contenedorDatos.add(personaListView, 1, 6,10,6);
        contenedorDatos.add(separador2, 1, 12,10,1);
        contenedorDatos.add(inscripcionLabel, 1, 13);
        contenedorDatos.add(InscripcionListView, 1, 14,10,6);
        //contenedorDatos.add(separador4,15,0);
        contenedorDatos.setPadding(new Insets(15));
        
        
       contenedorDatos.add(entiadesLabel, 1, 20);
       contenedorDatos.add(entidadesListView, 1, 21,10,6);
        ...
        guardarButton.setOnAction((ActionEvent eh) -> {
            // modificar
        ...
        //carga de datos en la lista de Entidades
